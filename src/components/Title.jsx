...
const Title = ({
  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 sm:gap-2 max-w-7xl mx-auto px-8 p-8 md:px-0 md:py-8 min-h-[3.5rem]">
        ...
        <div className="flex items-center gap-4 mt-0 sm:mt-[5px]">
          ...
          <div className="flex gap-2 sm:gap-4">
            <Link
              href="/blog"
              className="p-1 text-neutral-600 hover:text-neutral-800 dark:text-neutral-400 dark:hover:text-neutral-200 transition-colors flex items-center text-center font-medium"
              aria-label="Blog"
            >
              My Blog
            </Link>
